  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        setError(
          "Failed to load data and generate insights. Please try again later."
        );
      } finally {
        setIsLoading(false);
      }
      ...
      <div className="bg-slate-900 py-8">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-400 mb-6">
            Discover patterns, trends, and research gaps in NASA space biology
            publications.
          </p>
            ...
            <StatCard
              ...
              value={
                publications.length > 0
                  ? `${Math.min(
                      ...publications.map((p) => p.year || 0)
                    )}-${Math.max(...publications.map((p) => p.year || 0))}`
                  : "N/A"
              }
            ...
            <section>
              <div className="glass-card p-6 text-center">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                  Explore the publications dashboard to search through all 608
                  publications, or check out the visualizations page for
